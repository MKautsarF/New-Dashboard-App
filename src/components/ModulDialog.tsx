    ...
    <Dialog open={open} onClose={() => setOpen()}>
      ...
      <DialogContent className="w-[600px] px-6">
        ...
        <TextField
          ...
          label={
            <span>
              Nama Modul Pembelajaran <span style={{ color: "red" }}>*</span>
            </span>
          }
          type="text"
          fullWidth
        ...
        <FormControl fullWidth variant="standard" margin="normal">
          <InputLabel id="train-label">
            Jenis Kereta <span style={{ color: "red" }}>*</span>
          </InputLabel>
          <Select
            labelId="train-label"
            id="train"
        ...
        <TextField
          ...
          label={
            <span>
              Berat Kereta (ton) <span style={{ color: "red" }}>*</span>
            </span>
          }
          type="number"
          fullWidth
        ...
        >
          <InputLabel id="train-label">
            Line Kereta <span style={{ color: "red" }}>*</span>
          </InputLabel>
          <Select
        ...
        >
          <InputLabel id="train-label">
            Stasiun Awal <span style={{ color: "red" }}>*</span>
          </InputLabel>
          <Select
          ...
          >
            {startStations.map((station) => (
              <MenuItem key={station} value={getDisplayStationName(station)}>
        ...
        >
          <InputLabel id="train-label">
            Stasiun Akhir <span style={{ color: "red" }}>*</span>
          </InputLabel>
          <Select
            ...
            onChange={(e) =>
              setFinishStation(getPayloadStationName(e.target.value))
            }
            label="Stasiun Akhir"
          >
        ...
        <FormControl fullWidth variant="standard" margin="normal">
          <InputLabel id="train-label">
            Status Hujan <span style={{ color: "red" }}>*</span>
          </InputLabel>
          <Select
            labelId="rain-status"
            id="rainStatus"
        ...
        <div className="flex items-center mt-3 gap-3">
          ...
          <Input
            ...
            endAdornment={
              <InputAdornment
                position="start"
                className={`${jarakPandang !== 0 ? "text-base" : "text-xs"}`}
              >
        ...
        <TextField
          ...
          label={
            <span>
              Speed Limit (km/h){" "}
              {speedBuzzer && <span style={{ color: "red" }}>*</span>}
            </span>
          }
          type="number"
          fullWidth
